            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <h3 className="text-base font-display font-bold text-green-700">Your Wallet</h3>
                </div>
                <div className="bg-white bg-opacity-60 rounded-xl p-2.5 border-2 border-pink-300">
                  <p className="text-xs text-green-600 font-body mb-0.5">Address:</p>
                  <p className="text-sm md:text-base font-mono text-green-800 break-all leading-snug">
                    {address}
                  </p>
                </div>
              </div>
              <button
                ...
                className="bg-pink-500 hover:bg-pink-400 text-white font-display font-bold py-2 px-4 rounded-full border-3 border-brown-500 shadow-ac-sm hover:shadow-ac transition-all transform hover:-translate-y-0.5 flex items-center gap-2 justify-center md:flex-shrink-0 text-sm"
              >
                <span>📋</span>
